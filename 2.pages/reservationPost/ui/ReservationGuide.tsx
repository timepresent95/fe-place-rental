function ReservationGuide() {
  return (
    <div>
      <div className="bg-yellow-100 rounded-lg p-4 pb-7 break-keep">
        ...
        <div className="space-y-2 mb-3">
          ...
          <ol className="list-decimal pl-4 text-sm space-y-1">
            ...
            <li>특정 정당이나 개인의 정치활동 및 홍보를 목적으로 하는 경우</li>
        ...
        <p className="text-sm">사용 승인 시간 엄수 및 부대 장비 사용법 숙지</p>
      </div>
    </div>
  );
}

ReservationGuide.displayName = "ReservationGuide";
